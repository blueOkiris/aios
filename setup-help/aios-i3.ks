...
bindsym \$mod+L exec i3lock-fancy --nofork
...
# Start-up stuff
exec_always --no-startup-id \$HOME/Applications/i3-alternating-layout/alternating_layouts.py
...
chown -R liveuser:liveuser /home/liveuser/.config/i3
mkdir -p /root/.config/i3
cp -r /home/liveuser/.config/i3/config /root/.config/i3
